...
{
  "part1_general": {
    "need_1_user_desire": "이용아동의 욕구 및 문제점 분석 내용 (한국어 문자열)",
    "need_2_local_env": "지역 환경적 특성 분석 내용 (한국어 문자열)",
    "feedback_table": [
...
- part1_general의 각 필드(need_1_user_desire, need_2_local_env, purpose_text, goals_text)를 반드시 별도로 분석하여 작성하세요.
...
def get_default_data() -> dict:
    ...
    return {
        "part1_general": {
            "need_1_user_desire": "이용아동들은 안정적인 돌봄 환경과 다양한 교육 기회를 원하고 있습니다. 특히 방과후 시간대의 체계적인 프로그램과 정서적 지원에 대한 욕구가 높게 나타났습니다. 학업 지원과 함께 또래 관계 형성, 자기표현 능력 향상에 대한 요구도 확인되었습니다.",
            "need_2_local_env": "지역 내 맞벌이 가정 및 한부모 가정이 증가하고 있어 아동 돌봄 서비스 수요가 지속적으로 증가하고 있습니다. 지역사회 내 다양한 복지기관 및 교육기관과의 연계 가능성이 높으며, 지역 축제 및 문화행사 참여 기회도 풍부합니다.",
            "feedback_table": [
