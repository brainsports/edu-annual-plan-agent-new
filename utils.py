...
필수 JSON 구조:
{
  "part1_general": {
    ...
    "total_review_table": [
      {"category": "운영평가", "content": "**📊 시설운영**: 상세설명...\\n\\n**📈 인력관리**: 상세설명...\\n\\n**💰 예산집행**: 상세설명... (각 소제목별로 상세히, 총 약 1000자)"},
      {"category": "아동평가", "content": "**👶 이용현황**: 상세설명...\\n\\n**📚 발달성과**: 상세설명...\\n\\n**😊 만족도**: 상세설명... (각 소제목별로 상세히, 총 약 1000자)"},
      {"category": "프로그램평가", "content": "**📋 프로그램운영**: 상세설명...\\n\\n**✅ 목표달성**: 상세설명...\\n\\n**🔄 개선사항**: 상세설명... (각 소제목별로 상세히, 총 약 1000자)"},
      {"category": "후원활동측면", "content": "**🤝 후원현황**: 상세설명...\\n\\n**🏢 기업연계**: 상세설명...\\n\\n**🌐 네트워크**: 상세설명... (각 소제목별로 상세히, 총 약 1000자)"},
      {"category": "환류방안", "content": "**🎯 차년도목표**: 상세설명...\\n\\n**📝 개선계획**: 상세설명...\\n\\n**🔧 실행방안**: 상세설명... (각 소제목별로 상세히, 총 약 1000자)"}
    ],
    "satisfaction_survey": {
...
- **total_review_table은 반드시 5개 영역(운영평가, 아동평가, 프로그램평가, 후원활동측면, 환류방안) 순서로 작성하세요.**
  ...
  - **[가독성 향상 필수 규칙 - 소제목 볼드 서식]**:
    - 절대로 줄글(wall of text)로 작성하지 마세요!
    - 반드시 **[이모지] [핵심키워드]**: [상세설명] 형식으로 구조화하세요.
    - 각 소제목 사이에 빈 줄(\\n\\n)을 삽입하여 시각적으로 분리하세요.
    - 예시 형식:
      "**📊 시설운영**: 2024년 시설 운영률 95%를 달성하였으며...\\n\\n**📈 인력관리**: 전문인력 8명을 안정적으로 운영하며...\\n\\n**💰 예산집행**: 총 예산의 98.5%를 계획대로 집행하여..."
    - 각 영역당 최소 3개 이상의 소제목으로 구조화하세요.
- **need_1_user_desire, need_2_1_regional, need_2_2_environment, need_2_3_educational, subjective_analysis, overall_suggestion 작성 시에도 동일하게 소제목 볼드 서식을 적용하세요.**
  - 형식 예시: "**📋 현황분석**: 설명내용...\\n\\n**🎯 핵심과제**: 설명내용...\\n\\n**💡 시사점**: 설명내용..."
    ...
    return {
        "part1_general": {
            ...
            "total_review_table": [
                ...
                {"category": "프로그램평가", "content": "**📋 운영현황**: 2024년 총 15개 프로그램을 운영하였으며, 프로그램별 참여율은 평균 89%를 기록하였습니다.\n\n**📖 교육프로그램**: 교육 프로그램(학습지도, 독서지도, 디지털교육)은 총 48회 운영되었으며, 참여 아동의 학습 능력 향상에 크게 기여하였습니다. 특히 디지털 리터러시 교육은 신규 도입된 프로그램으로 아동과 보호자 모두에게 높은 호응을 얻었습니다.\n\n**🎨 문화프로그램**: 문화 프로그램(체험활동, 예술교육)은 연간 12회 운영되었으나, 다양성 측면에서 개선이 필요한 것으로 평가되었습니다.\n\n**💝 정서지원**: 정서지원 프로그램(개별상담, 집단상담, 또래활동)은 총 156회 운영되었으며, 참여 아동의 정서 안정에 긍정적인 효과를 보였습니다.\n\n**✅ 만족도분석**: 프로그램 만족도 조사 결과, 교육 프로그램 4.4점, 정서지원 4.3점, 보호 4.5점, 문화 3.9점으로 나타나 문화 프로그램 강화가 필요한 것으로 분석되었습니다."},
                ...
                {"category": "환류방안", "content": "**🎯 운영시간 개선**: 운영 시간 연장 요구에 대응하여 저녁 돌봄 시간을 18시에서 20시로 연장하고, 이를 위한 야간 돌봄 인력 1명을 추가 배치합니다.\n\n**🎨 문화프로그램 확대**: 문화체험 프로그램 다양성 부족 문제 해결을 위해 월 1회 이상 외부 문화체험 활동을 실시하고, 지역 문화시설과 연계 협약을 체결합니다.\n\n**📝 맞춤형 학습지원**: 개별 아동 맞춤형 지원 강화를 위해 학습 진단 도구를 도입하고 개별 학습 계획(ILP)을 수립하여 체계적인 학습 지원을 제공합니다.\n\n**🚨 위기아동 지원체계**: 위기 아동 조기 발견 체계 구축을 위해 분기별 스크리닝을 실시하고 아동보호전문기관과 협력 체계를 강화합니다.\n\n**💻 디지털환경 개선**: 디지털 교육 환경 개선을 위해 태블릿 20대를 추가 확보하고 스마트 학습 플랫폼을 도입합니다.\n\n**🔧 후원개발 강화**: 후원 개발 활동 강화를 위해 기업 CSR 담당자 네트워크를 구축하고 정기후원자 60명 확보를 목표로 홍보 활동을 강화합니다."}
            ],
            "satisfaction_survey": {
                "total_respondents": 30,
                "survey_data": [
