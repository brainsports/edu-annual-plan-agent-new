...
필수 JSON 구조:
{
  "part1_general": {
    ...
    "satisfaction_survey": {
      "questions_list": [
        {"question": "급식 및 간식의 질과 위생 상태에 만족하십니까?", "score": 4.5},
        {"question": "프로그램 내용과 운영에 만족하십니까?", "score": 4.3},
        {"question": "시설의 안전 및 위생 관리에 만족하십니까?", "score": 4.6},
        {"question": "담당 선생님의 아동 지도 능력에 만족하십니까?", "score": 4.4},
        {"question": "학습지도 프로그램의 효과에 만족하십니까?", "score": 4.2},
        {"question": "아동의 정서적 지원에 만족하십니까?", "score": 4.3},
        {"question": "부모 상담 및 소통에 만족하십니까?", "score": 4.1},
        {"question": "문화체험 활동에 만족하십니까?", "score": 3.9},
        {"question": "시설 운영 시간에 만족하십니까?", "score": 4.0},
        {"question": "전반적인 시설 운영에 만족하십니까?", "score": 4.4}
      ],
...
- **satisfaction_survey 작성 규칙:**
  - questions_list: 업로드된 문서에서 만족도 조사 질문을 추출하세요. 없으면 아동복지시설 평가 표준 항목(급식, 프로그램, 안전, 교사, 학습지도, 정서지원, 소통, 문화활동, 운영시간, 전반적 만족도) 10개를 사용하세요.
  - score: 각 질문에 대해 5점 만점 기준으로 실제적인 점수(예: 4.2, 4.5)를 생성하세요.
...
def get_default_data() -> dict:
    ...
    return {
        "part1_general": {
            ...
            "satisfaction_survey": {
                "questions_list": [
                    {"question": "급식 및 간식의 질과 위생 상태에 만족하십니까?", "score": 4.6},
                    {"question": "프로그램 내용과 운영에 만족하십니까?", "score": 4.4},
                    {"question": "시설의 안전 및 위생 관리에 만족하십니까?", "score": 4.5},
                    {"question": "담당 선생님의 아동 지도 능력에 만족하십니까?", "score": 4.5},
                    {"question": "학습지도 프로그램의 효과에 만족하십니까?", "score": 4.2},
                    {"question": "아동의 정서적 지원에 만족하십니까?", "score": 4.3},
                    {"question": "부모 상담 및 소통에 만족하십니까?", "score": 4.1},
                    {"question": "문화체험 활동에 만족하십니까?", "score": 3.9},
                ...
                "subjective_question": "기타 건의사항 및 개선 의견",
                "subjective_analysis": "주관식 응답 분석 결과, 학부모들은 전반적으로 시설 운영에 높은 만족감을 표현하였습니다. 가장 많이 언급된 긍정적 의견으로는 담당 선생님들의 헌신적인 아동 지도 태도, 안전하고 청결한 시설 환경, 영양가 있는 급식 제공 등이 있었습니다. 특히 코로나19 이후 방역 관리에 대한 신뢰가 높게 나타났으며, 아동들이 즐겁게 센터에 다니고 있다는 피드백이 다수였습니다. 개선이 필요한 부분으로는 저녁 돌봄 시간 연장 요청이 가장 많았으며(전체 응답의 35%), 다양한 문화체험 프로그램 확대(28%), 학습지도 프로그램의 다양화(20%) 순으로 나타났습니다. 일부 학부모는 주말 프로그램 신설과 방학 기간 특별 프로그램을 희망하였습니다. 또한 부모 참여 프로그램 및 가정 연계 활동에 대한 요구도 있었으며, 아동 개별 상담 결과 공유에 대한 요청도 제기되었습니다.",
                "overall_suggestion": "2024년 만족도 조사 결과, 전체 평균 만족도 점수는 5점 만점에 4.29점으로 전년 대비 0.15점 상승하였습니다. 가장 높은 만족도를 보인 항목은 '급식 및 간식'(4.6점)과 '시설 안전 관리'(4.5점)로, 기본적인 돌봄 서비스에 대한 신뢰가 높은 것으로 분석됩니다. 반면 '문화체험 활동'(3.9점)과 '운영 시간'(4.0점)은 상대적으로 낮은 점수를 기록하여 개선이 필요한 것으로 나타났습니다. 이에 따른 제언으로, 첫째 문화체험 프로그램을 월 1회 이상으로 확대하고 다양한 장르(공연, 전시, 스포츠 등)를 포함할 것을 권고합니다. 둘째, 맞벌이 가정의 요구를 반영하여 저녁 돌봄 시간을 20시까지 연장 운영하는 방안을 검토해야 합니다. 셋째, 학습지도의 효과성 향상을 위해 개별 맞춤형 학습 계획 수립과 정기적인 학습 성과 공유 시스템을 도입할 필요가 있습니다. 이러한 개선 사항을 차년도 사업 계획에 반영하여 이용자 만족도 향상에 기여할 것을 제안합니다."
            },
